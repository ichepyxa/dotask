...
import { changeTodo, removeTodo } from 'store/slices/todosSlices'
...
const TodoItem: FC<TodoItemProps> = ({
	...
	return (
		<div
			className={`shadow shadow-slate-500 p-6 rounded-2xl transition ${
			...
			<div className="flex justify-between items-center">
				<div className="flex items-center gap-3">
					<input
						...
						className="border-2 border-black/30 appearance-none checked:bg-blue-500 w-6 h-6 rounded-lg transition cursor-pointer"
					/>
					<h2
